...
<div class="container">
	<form action="ControllerProduitServlet?action=edit&id=<%= request.getParameter("id")%>"" method="post">
			<div class="form-group"><label> Nom produit </label> <input class="form-control" type="text"  name="nom_produit"> <br/></div>
			<div class="form-group"><label> prix produit </label> <input class="form-control" type="text"  name="prix_produit"> <br/></div>
