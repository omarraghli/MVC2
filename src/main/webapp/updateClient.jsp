...
<div class="container">
	<form action="ControllerClientServlet?action=edit&id=<%= request.getParameter("id")%>" method="post">
			<div class="form-group"><label> Nom </label> <input class="form-control" type="text"  name="nom"> <br/></div>
			<div class="form-group"><label> Prenom </label> <input class="form-control" type="text"  name="prenom"> <br/></div>
			<div class="form-group"><label> Age </label> <input class="form-control" type="text"  name="age"> <br/></div>
