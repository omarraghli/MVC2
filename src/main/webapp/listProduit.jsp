...
<% List<Produit> list = (List<Produit>) request.getAttribute("listp"); 
for(int i = 0 ; i <list.size() ; i++){ %>

<tr>
<td><%= list.get(i).getId_produit()%> </td>


<td><%= list.get(i).getNom_produit() %>  </td>


<td><%= list.get(i).getPrix_produit()  %> </td>


<td> <a class="btn btn-info" href="updateProduit.jsp?id=<%= list.get(i).getId_produit() %>"> Editer</a> </td>

<td> <a class="btn btn-danger" href="ControllerProduitServlet?action=delete&id=<%= list.get(i).getId_produit() %>"> Supprimer</a> </td>
