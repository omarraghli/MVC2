<%@page import="com.fstt.model.Client"%>
...
<% List<Client> list = (List<Client>) request.getAttribute("listp"); 
for(int i = 0 ; i <list.size() ; i++){ %>

<tr>
<td><%= list.get(i).getId_client() %> </td>
...
<td> <a class="btn btn-info" href="updateClient.jsp?id=<%= list.get(i).getId_client() %>"> Editer</a> </td>

<td> <a class="btn btn-danger" href="ControllerClientServlet?action=delete&id=<%= list.get(i).getId_client() %>"> Supprimer</a> </td>
